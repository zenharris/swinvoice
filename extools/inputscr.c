...
{
    int iter,pcol;
    char println[81],*temp,fmtbuff[10];
      ...
      /*     *compstr = 0;
           ...
           do {
              wch = linedt(tbl[iter].field,tbl[iter].row,
                            ...
                            tbl[iter].fattr,&crnt_pos,&edmode,tbl[iter].cmndline,filedef);
           ...
           do {
              wch = datedt(tbl[iter].field,tbl[iter].row,
                           tbl[iter].col + strlen(tbl[iter].prompt),tbl[iter].fattr,
                           &crnt_pos,&edmode,tbl[iter].cmndline,filedef);
                       ...
                       case 'i':
                          ...
                          do {
                             do {
                                ...
                                wch = linedt(buff,tbl[iter].row,pcol,tbl[iter].lnth,tbl[iter].fattr,
                                             &crnt_pos,&edmode,tbl[iter].cmndline,filedef);
