...
int command_line (struct cmndline_params[],uint16 *,void *,void *);
...
int linedt(char *,int,int,int,int,int *,unsigned int *,struct cmndline_params *,void *);
int enter_screen(struct scr_params[],int,int *,enum en_mode_type,void *,int *);
int init_screen();


int datedt(struct date_only *,int,int,int,int *,unsigned int *,struct cmndline_params[],void *);
int datimedt(struct date_time *,int,int,int,int *,unsigned int *,struct cmndline_params[],void *);
